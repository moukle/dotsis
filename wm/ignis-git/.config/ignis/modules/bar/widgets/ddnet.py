    ...
    def FriendButton(self, f: OnlineFriend):
        return Widget.Button(
            ...
            child=Widget.CenterBox(
                ...
                center_widget=Widget.Label(label="  "),
            ...
            child=Widget.EventBox(
                ...
                child=ddnet.bind(
                    ...
                    transform=lambda friends_online: [
                        self.FriendButton(f) for f in friends_online
                    ],
                ),
            ),
        )
...
class DDNet(Widget.Button):
    def __init__(self):
            ...
            child = ddnet.bind(
                ...
                transform=lambda value: Widget.Box(
                    child=[
                        ...
                        Widget.Label(label=str(len(value)), css_classes=["ddnet-open"]),
                    ]
                    if len(value) > 0
                    else []
                ),
        ...
        _, rect = self.compute_bounds(self)
        x1 = rect.get_bottom_right().x
        x2 = rect.get_bottom_left().x
        self._friends_detailed.margin_right = x1 - x2
